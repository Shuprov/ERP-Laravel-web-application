                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="table-data__tool-right">
                         <a href='/companies/create'><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>company data</h3>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($companylist as $user)
                                                   ...
                                                   <!--<td>
                                                    ...
                                                    <td>
                                                        <a href="/companies/edit/{{$user['id']}}">Edit</a></td>
                                                        <td><a href="/companies/delete/{{$user['id']}}">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
