...
<div>
    <a href='/user'><button type="submit" name="back" class="btn btn-info btn-sm">Back</button></a>
    <a href='/logout'><button type="submit" name="logout" class="btn btn-danger btn-sm">Logout</button></a>
</div>
                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    {{--<input type="password" id="password" name="repassword" placeholder="Retype Password" class="form-control">--}}
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="password" name="role" value="{{$user->role}}" placeholder="Role" class="form-control">
                                                    {{--<input type="password" id="password" name="repassword" placeholder="Retype Password" class="form-control">--}}
                                            ...
                                            <div class="form-actions form-group">
                                                ...
                                                <!--<input type="submit" name="create"  class="form-control" value="create">-->
                                                <!--<input <button class="btn btn-success btn-sm"> type="submit"  name="create"  class="form-control" value="create"></button>-->
