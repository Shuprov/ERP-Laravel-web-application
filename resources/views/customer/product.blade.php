                                    ...
                                    @foreach ($asus as $row)
                                        <div class="col-sm-4">
                                            <div class="banner banner-cat banner-badge">
                                                <a href="#">
                                                    <img src="assets/images/category/fullwidth-page/banner-2.jpg"
                                                        alt="Banner">
                                                </a>

                                                <a class="banner-link" href="{{ route('product_details', $row->id) }}">
                                                    <h3 class="banner-title">Product Id:{{ $row->product_id }}<br>Shop
                                                        Id: {{ $row->shop_id }}<br>Product
                                                        Name:{{ $row->product_name }}<br>Product
                                                        Price{{ $row->product_price }}<br>Product
                                                        details:{{ $row->product_details }}</h3>
                                                    <!-- End .banner-title -->
