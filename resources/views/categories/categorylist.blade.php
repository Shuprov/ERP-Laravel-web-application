                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="table-data__tool-right">
                         <a href='/categories/create'><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>category data</h3>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($categorylist as $user)
                                                   ...
                                                   <!--<td>
                                                    ...
                                                    <td>
                                                        <a href="/categories/edit/{{$user['id']}}">Edit</a></td>
                                                        <td><a href="/categories/delete/{{$user['id']}}">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="role user">accountant</span>
                                                    </td>
                                                    <td>
                                                        <div class="rs-select2--trans rs-select2--sm">
                                                            <select class="js-select2" name="property">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="role user">Seller</span>
                                                    </td>
                                                    <td>
                                                        <div class="rs-select2--trans rs-select2--sm">
                                                            <select class="js-select2" name="property">
